...
//    static const char *g_label[13] = {"Spacing",
//                                           "Spacer",
//                                           "Title box",
//                                           "Spacer",
//                                           "Icon box",
...
//    lv_obj_set_style_grid_row_align(cont, LV_GRID_ALIGN_START, 0);
//    for(int i =0; i<13; i++){
//        lv_obj_t *obj_grid = lv_obj_create(cont);
//        lv_obj_set_size(obj_grid, 10, 10);
//        lv_obj_set_style_pad_all(obj_grid, 0, 0);
//        lv_obj_set_style_border_width(obj_grid, 1, 0);
//        lv_obj_set_style_border_color(obj_grid, lv_color_hex(0x111111), 0);

//        lv_obj_set_style_bg_color(obj_grid, lv_color_hex(0xaabbcc+(i*60)<<(i+4)), 0);
//        lv_obj_set_grid_cell(obj_grid, LV_GRID_ALIGN_STRETCH, 0, 1, LV_GRID_ALIGN_STRETCH, i, 1);

//        lv_obj_t *grid_label = lv_label_create(obj_grid);
//        lv_obj_set_align(grid_label,LV_ALIGN_CENTER);
//        lv_obj_set_style_text_font(grid_label, &lv_font_montserrat_10, 0);
//        lv_label_set_text(grid_label, g_label[i]);
//    }
...
//    lv_obj_set_style_bg_color(main_cont, lv_color_hex(0xffffff), LV_PART_ITEMS);
...
//            draw_dsc.bg_color = lv_color_hex(0x0ff00f);
//            {
//                static int x0=10,y0=10,x1=320,y1=12,x2=330,y2=294,x3=20,y3=299;
//                poly[0].x=x0;poly[0].y=y0;
...
//            {
//                static lv_area_t *clip_a;
//                static int flag = 0;
//                static lv_obj_t *tmp_obj;
//                if(flag==0){
//                    tmp_obj = lv_obj_create(lv_scr_act());
//                    lv_obj_set_size(tmp_obj,100,200);
//                }
//                lv_draw_polygon(poly, 4, &clip_a, &draw_dsc);
//            }

//            lv_obj_invalidate_area(lv_scr_act(), clip_area);
//            return;
